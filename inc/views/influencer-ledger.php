<?php
    ...
    $commissions_sql = "SELECT c.user_id,c.amount,c.date_added,c.id as tran_id, 'COMMISSION' as type, concat('Commission for Order #',c.order_id,' Coupon Code: ',p.post_name) as description  FROM $commissions_tbl as c 
