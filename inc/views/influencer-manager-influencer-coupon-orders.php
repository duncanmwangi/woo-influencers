<?php
	...
	$sql = "SELECT c.*,i.coupon_id FROM $commissions_tbl as c 
		...
		WHERE u.user_id = $current_user_id AND i.coupon_id = $coupon_id ORDER BY c.date_added ASC";
...
?>
	...
	<div class="row mx-0">           
		...
		<div class="col-md-12 mx-0 px-0">
			...
			<?=wi_pagination($sql,$current_page, $WI_Influencer->get_url('my-influencer-coupon-orders','&cpid='.$coupon_id)) ?>
		</div>
	</div>
